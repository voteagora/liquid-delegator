...
contract AlligatorV2Bravo is AlligatorV2 {
    // =============================================================
    //                         CONSTRUCTOR
    // =============================================================
    ...
    function _propose(
        ...
        return IGovernorBravoExtended(proxy).propose(targets, values, signatures, calldatas, description);
    }
    ...
    function _castRefundableVoteWithReason(
        ...
        IGovernorBravoExtended(proxy).castRefundableVoteWithReason(proposalId, support, reason);
    }
    ...
    function _proposalEndBlock(uint256 proposalId) internal view override returns (uint256) {
        return IGovernorBravoExtended(governor).proposals(proposalId).endBlock;
    }
}
